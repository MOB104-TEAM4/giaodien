...
public class Login extends javax.swing.JFrame {
    ...
    public String login(String username, String password){
        for(TaiKhoan tk : TaiKhoan.values()){
            if(tk.getUser().equals(username) && tk.getPass().equals(password)){
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Chúng tôi đi làm vì bạn, xin bạn ở nhà vì chúng tôi");
        ...
        txt_pass.setBackground(new java.awt.Color(51, 153, 255));
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/NAME48.png"))); // NOI18N
        ...
        btn_reset.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(204, 204, 204)));
        ...
        jLabel8.setText("QUẢN LÝ CÁCH LY Ở TPHCM");
    ...
    private void btn_loginMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_loginMouseClicked
        ...
        if(currentUser != null){
            this.dispose();
            new GiaoDien(currentUser).setVisible(true);
        }
        else{
            JOptionPane.showMessageDialog(this,
                    "Đăng nhập thất bại","CẢNH BÁO",JOptionPane.ERROR_MESSAGE);
        }
